...
/mnt/SDCARD/System/bin/jq '. += {"VNC": 0}' "$json_file" >"/tmp/json_file.tmp" && mv "/tmp/json_file.tmp" "$json_file"
...
/mnt/SDCARD/System/usr/trimui/scripts/mainui_state_update.sh "VNC" "disabled"
