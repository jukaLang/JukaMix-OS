...
/mnt/SDCARD/System/usr/trimui/scripts/set_ra_cfg.sh "/mnt/SDCARD/RetroArch/retroarch.cfg"  "savestate_auto_load" "false"
...
/mnt/SDCARD/System/usr/trimui/scripts/mainui_state_update.sh "AUTO LOAD STATE" "disabled"