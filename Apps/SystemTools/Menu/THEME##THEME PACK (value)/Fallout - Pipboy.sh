...
# style: 2 styles available: "Default" and "JukaMix - Refreshed",
...
packname="Fallout - Pipboy"
style="JukaMix - Refreshed"
theme="Fallout - Pipboy"
bootlogo="Fallout - Pipboy.bmp"
emuicons="Fallout - Pipboy"
appicons="Default"
