...
echo
echo "Do you want to enable the JukaMix OS dev profile? [Y/n] "
stty -echo -icanon
...
┌──────────────────────────────────────────────────────────────────────────┐
│  The JukaMix OS dev profile for SSH grants easier access to all binaries   │
│  and libraries configured in JukaMix OS. However, this is not the standard │
...
EOF
    ...
    echo "JukaMix OS dev profile not enabled."
fi
