...
refresh_osd_cpu_info_widget() {
    ...
    ./get_info.sh
    /mnt/SDCARD/System/bin/python3.11 ./text_image.py || rm "/tmp/jukamix_cpu_info/app_cpu_info.png"
    # /mnt/SDCARD/System/bin/python3.11 /usr/trimui/osd/widgets/app_info/check_image.py

    if [ -f "/tmp/jukamix_cpu_info/app_cpu_info.png" ]; then
        TMP_FILE="/tmp/jukamix_cpu_info/.vfb_osd_tmp"
        FINAL_FILE="/tmp/jukamix_cpu_info/vfb_osd"

        ./pic2argb /tmp/jukamix_cpu_info/app_cpu_info.png "$TMP_FILE" || {
