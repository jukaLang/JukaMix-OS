...
refresh_osd_info_widget() {
    ...
    /mnt/SDCARD/System/bin/python3.11 ./text_image.py || rm "/tmp/jukamix_info/app_info.png"
    # /mnt/SDCARD/System/bin/python3.11 /usr/trimui/osd/widgets/app_info/check_image.py
    
    
    
if [ -f "/tmp/jukamix_info/app_info.png" ]; then
    TMP_FILE="/tmp/jukamix_info/.vfb_osd_tmp"
    FINAL_FILE="/tmp/jukamix_info/vfb_osd"

    ./pic2argb /tmp/jukamix_info/app_info.png "$TMP_FILE" || {
