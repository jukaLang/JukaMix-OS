...
FILES_TO_CHECK="/mnt/SDCARD/System/usr/trimui/scripts/jukamix_update.sh
...
if [ -f "/mnt/SDCARD/betatest" ]; then
    ...
    download_file "update_ota_release.sh" "https://raw.githubusercontent.com/jukaLang/JukaMix-OS/refs/heads/main/System/usr/trimui/scripts/update_ota_release.sh" -d "/mnt/SDCARD/System/usr/trimui/scripts"
fi

if [ ! "$currentUpdatePack" = "$onlineUpdatePack" ] || [ "$missing_files" -eq 1 ]; then
    download_file "jukamix_update.sh" "https://raw.githubusercontent.com/$GITHUB_REPOSITORY/refs/heads/main/System/usr/trimui/scripts/jukamix_update.sh" -d "/mnt/SDCARD/System/usr/trimui/scripts"
