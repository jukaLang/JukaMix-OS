...
- You can also use shortcuts to avoid to duplicate your roms in the "Best" section, just create a .txt file with the path of the rom (See the example of this pack : "FreeGamesCollection\Roms\VB\VB Racing - shortcut example.txt")
